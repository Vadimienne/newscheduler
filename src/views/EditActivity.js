...
function NewActivity({ navigation, editTodo, route }) {
    ...
    const [ minutesADay, setMinutesADay ] = useState((typeof task.minutesADay) == 'number'? task.minutesADay.toString(): task.minutesADay)
